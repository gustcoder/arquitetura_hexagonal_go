...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(arg0 application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Disable indicates an expected call of Disable.
func (mr *MockProductServiceInterfaceMockRecorder) Disable(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disable", reflect.TypeOf((*MockProductServiceInterface)(nil).Disable), arg0)
}

// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(arg0 application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable indicates an expected call of Enable.
func (mr *MockProductServiceInterfaceMockRecorder) Enable(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enable", reflect.TypeOf((*MockProductServiceInterface)(nil).Enable), arg0)
}
